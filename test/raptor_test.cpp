...
queue<CData*> encoder_test(U32 k, U32 dataLen, U32 lossNum, U32 EXTNUM)
{
...
U32 main(U32 argc, CHAR* argv[])
{
  ...
  printf("--------------------------Encoder-----------------------------\n");
  encoded_sym = encoder_test(k, dataLen, lossNum, EXTNUM);
  ...
  U32 state = decoder_test(k, encoded_sym, receivedSymSize, lossNum, ESI_vector);
  //printf("!!!\n");
  return 0;
}